...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { property: "og:image", content: socialShareAsset.url },
      { name: "twitter:image", content: socialShareAsset.url },
    ...
    scripts: [
      {
        async: true,
        src: "https://www.googletagmanager.com/gtag/js?id=G-J1KB94KVL3",
      },
      {
        children: `window.dataLayer = window.dataLayer || [];
function gtag(){dataLayer.push(arguments);}
gtag('js', new Date());
gtag('config', 'G-J1KB94KVL3');`,
      },
      {
